...
class Vacancy(models.Model):
    ...
    responsibilities = CKEditor5Field(verbose_name=_('responsibilities'))
    requirements = CKEditor5Field(verbose_name=_('requirements'))
    conditions = CKEditor5Field(verbose_name=_('conditions'))
...
class Action(models.Model):
    ...
    desc = CKEditor5Field(verbose_name=_("description"))
...
class AboutUs(models.Model):
    ...
    summary = CKEditor5Field(_("summary"))
...
class Specialist(models.Model):
    ...
    about = CKEditor5Field(_("about"))
    certificates = CKEditor5Field(_("certificate"))
